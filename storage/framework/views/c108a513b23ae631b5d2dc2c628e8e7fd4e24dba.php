...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
     ...
     <ul class="treeview-menu">
       <li class="<?php echo e(Active::check('doctors/addnew')); ?>"><a href="/doctors/addnew"><i class="fa fa-circle-o"></i>Add New</a></li> 
       <li class="<?php echo e(Active::check('doctors/list')); ?>"><a href="/doctors/list"><i class="fa fa-circle-o"></i>List</a></li>
     </ul>
   </li>
